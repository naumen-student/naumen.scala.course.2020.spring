...
object Exercises {
    ...
    def prettyBooleanFormatter1(x: Any): String = x.getClass.getSimpleName match {
        case "boolean" => if (x.toString == "true") "правда" else "ложь"
        case _ => x.toString
    }
    ...
    def max2(xs: Seq[Int]): Seq[Int] = xs.isEmpty match {
        case true => Seq.empty[Int]
        case _ => xs.max +: Seq.empty[Int]
    }
    ...
    case class MyCollection(args: Int*) extends Iterable[Int]{

object Exercises {
  ...
  */
  ...
  def sortByHeavyweight(ballsArray: Map[String, (Int, Double)] = balls): Seq[String] = {
    ballsArray.toList.sortWith((ball1, ball2) => byMass(ball1, ball2)).map(_._1)
  }

  def byMass(ball1: (String, (Int, Double)), ball2: (String, (Int, Double))): Boolean = {
    var coef = 4 / 3.0 * java.lang.Math.PI;
    ball1._2._1 * ball1._2._1 * coef * ball1._2._2 < ball2._2._1 * ball2._2._1 * coef * ball2._2._2
  }
